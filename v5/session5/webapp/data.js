...
const DATA = {
  ...
  pretrain: [
    ...
    },
    {
      ...
      datasets: ["AON/Reasoning (85B)", "proof-pile-2 (55B)", "D4 STEM (49B)", "peS2o (42B)"],
    },
    {
      lane: "Reasoning",
      share: 6,
    ...
    },
    {
      ...
      datasets: ["SWE-Gym (150M)", "SWE-smith (120M)", "OpenHands (90M)", "ToolBench (80M)", "ToolACE (60M)", "Glaive FC (50M)", "NexusRaven (30M)", "xLAM (25M)", "Hermes (22M)"],
    },
  ],
  ...
  indicTiers: [
    ...
    },
    {
      ...
      demandB: 72,
      realSupplyB: 5,
      note: "BPCC 3B + Samanantar 2B → 14.4× gap → synthesis needed",
      color: "#fcd34d",
      qual: "Medium-low",
      warning: true,
    },
    {
      ...
      demandB: 72,
      realSupplyB: 0,
      note: "Purpose-built from verified seeds via teacher model",
      color: "#fde68a",
      qual: "Variable",
    },
  ],
  ...
  curriculumStages: [
    {
      ...
      tokenRange: "0–30B",
      position: 0,
      web: 50, code: 18, indic: 15, stem: 12, reasoning: 5, longctx: 0, agentic: 0,
      bands: "B0–B1",
    ...
    },
    {
      ...
      tokenRange: "30B–600B",
      position: 15,
      web: 34, code: 24, indic: 18, stem: 12, reasoning: 6, longctx: 3, agentic: 3,
      bands: "B0–B2",
    ...
    },
    {
      ...
      position: 50,
      web: 28, code: 24, indic: 18, stem: 12, reasoning: 8, longctx: 5, agentic: 5,
      bands: "B2–B3",
      note: "Reasoning and agentic shares grow. Web falls.",
    },
    {
      name: "Long-context",
      tokenRange: "1.4T–1.7T",
      position: 80,
      web: 25, code: 22, indic: 17, stem: 11, reasoning: 8, longctx: 12, agentic: 5,
      bands: "B3–B4",
      note: "Long-context surges to 12%. Sequences stretch.",
    },
    {
      name: "Anneal",
      tokenRange: "1.72T–1.96T",
      position: 92,
      web: 8, code: 20, indic: 28, stem: 10, reasoning: 18, longctx: 8, agentic: 8,
      bands: "B3–B5",
      note: "Reserved best data. Low LR. Concentrated quality.",
    },
  ],
  ...
  protectedFloors: [
    ...
    },
    {
      ...
      mechanism: "OPUS always-on channel; combined 8% always-on floor shared with Indic",
    },
  ],
};
